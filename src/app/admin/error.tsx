    ...
    <div className="flex flex-col items-center justify-center p-12 text-center">
      <div className="bg-slate-500 border border-slate-700 p-8 rounded-2xl max-w-md w-full">
        ...
        <p className="text-slate-500 mb-6 text-sm">
          Failed to load administrative data. Please try again.
        </p>
        <div className="flex justify-center gap-3">
          ...
          <Link href="/admin" className="bg-slate-700 hover:bg-slate-600 text-white text-sm font-medium py-2 px-4 rounded-lg transition-colors">
            Admin Home
          </Link>
        </div>
      </div>
